...
export const DailyChallenges: React.FC<DailyChallengesProps> = ({
    ...
    return (
      <Card className={`p-6 transition-all duration-500 ${shouldHighlight ? 'bg-gradient-to-br from-yellow-400/70 to-orange-500/70 backdrop-blur-sm border border-yellow-500/20' : ''}`}>            <div className="flex justify-between items-center mb-2">
